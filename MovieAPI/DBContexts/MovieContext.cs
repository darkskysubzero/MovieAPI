...
public class MovieContext(DbContextOptions<MovieContext> options) : DbContext(options)
{
    ...
    modelBuilder.Entity<MovieInfo>().HasData(
        new MovieInfo { Id = 1, Title = "Mission Impossible", Year = 1996, Rating = 7.1 },
        new MovieInfo { Id = 2, Title = "Toy Story", Year = 1995, Rating = 8.3 },
        new MovieInfo { Id = 3, Title = "Coco", Year = 2017, Rating = 8.4 },
        new MovieInfo { Id = 4, Title = "The Iron Giant", Year = 1999, Rating = 8.1 },
        new MovieInfo { Id = 5, Title = "Spider-Man - Into the spider-verse", Year = 2018, Rating = 8.4 },
        new MovieInfo { Id = 6, Title = "Your Name", Year = 2016, Rating = 8.4 },
        new MovieInfo { Id = 7, Title = "How to Train Your Dragon", Year = 2010, Rating = 8.1 },
        new MovieInfo { Id = 8, Title = "Lightyear", Year = 2022, Rating = 5.7 },
        new MovieInfo { Id = 9, Title = "The Girl with the Dragon Tattoo", Year = 2011, Rating = 7.8 },
        new MovieInfo { Id = 10, Title = "Avengers: Endgame", Year = 2019, Rating = 8.4 },
        new MovieInfo { Id = 11, Title = "The Equalizer", Year = 2014, Rating = 7.2 }
    );
