...
namespace Movie.API.Migrations
{
    ...
    [Migration("20241230165456_SeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie.API.Entities.MovieInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DirectorMovieInfo", b =>
                {
                    b.HasOne("Movie.API.Entities.Director", null)
                        .WithMany()
                        .HasForeignKey("DirectorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Movie.API.Entities.MovieInfo", null)
                        .WithMany()
