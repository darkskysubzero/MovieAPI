    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirectorMovieInfo", x => new { x.DirectorsId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_DirectorMovieInfo_Directors_DirectorsId",
                        column: x => x.DirectorsId,
                        principalTable: "Directors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DirectorMovieInfo_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirectorMovieInfo_MoviesId",
                table: "DirectorMovieInfo",
                column: "MoviesId");
        }
